        ...
        {CATEGORIES.slice(1).map((cat) => {
          ...
          return (
            <button
              ...
              style={{
                background:
                  category === cat ? "var(--accent-dim)" : "var(--card)",
        ...
        >
          <thead style={{ background: "var(--surface)" }}>
            <tr>
              ...
              <th
                style={{ ...thStyle("current"), textAlign: "right" }}
              ...
              <th
                style={{ ...thStyle("gainPct"), textAlign: "right" }}
              ...
              <th
                style={{ ...thStyle("xirr"), textAlign: "right" }}
              ...
              <th
                style={{ ...thStyle("conviction"), textAlign: "right" }}
              ...
              <th
                style={{ ...thStyle("holdingDays"), textAlign: "right" }}
